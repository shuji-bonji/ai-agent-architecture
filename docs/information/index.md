...
> For why this site scopes "AI agents" to LLM-driven agents, see [The Scope of This Site (FAQ)](../faq/scope-of-ai-agent.md). This section covers the **information side** connected to the reasoning core: RAG and data curation are **responses** to the LLM's structural constraints ([Knowledge Boundary](../glossary#structural-problems) / [Hallucination](../glossary#structural-problems)), while information governance (ownership, access rights, quality) is a **precondition for the connection** that holds even before any LLM is involved.
