...
::: warning このページの位置づけ
[エージェント概念の分類](./agent-taxonomy)（**WHAT KIND** — どんな種類のエージェントか）
...
| **扱わないこと**         | 権限管理の詳細（→ 権限管理ページ）、A2A 通信時の認証フロー（→ [A2Aとは](./what-is-a2a)）、Skill/MCP との責務分離（→ [II.1 五層](../part-2/layers)） |
| **依存**                 | [エージェント概念の分類](./agent-taxonomy)、[II.1 五層](../part-2/layers)                                                                         |
