...
| **[トークン](../glossary#token)消費** | 毎回[コンテキスト](../glossary#context)をゼロから再構築するため、入力が積み上がる |
| **精度劣化** | システムをまたいだ「関係性」は LLM がその場で推論せざるを得ず、[ハルシネーション](../glossary#structural-problems)の温床になる |
